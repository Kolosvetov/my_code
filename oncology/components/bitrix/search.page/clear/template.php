...
<div class="search-page">
	...
	<form action="" method="get">
		...
		<table class="unstylished" width="100%" border="0" cellpadding="0" cellspacing="0">
			<tbody><tr>
				<td style="width: 100%;">
				...
				<td>
					<input class="search-button button upc x-light radius" type="submit" value="<?echo GetMessage("CT_BSP_GO")?>" />
				</td>
			</tr>
		</tbody></table>
